...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="logo" style="display:flex; float:left; height:64px; width:120px;">
                    <a href="/dashboard" style="width:120px; margin:auto;">
                        <span class="fa fa-envelope" style="float:left;"></span>
                        <pre style="line-height:1.0;"> Mail Template</pre>
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div><img src="{{ Auth::user()->icon }}"></div>
